...
<head>
	...
	<script type="text/javascript">
		$(document).ready(function() {
			...
			/*
			 *  Thumbnail helper. Disable animations, hide close button, arrows and slide to next gallery pet if clicked
			 */
			...
			/*
			 *  Media helper. Group pets, disable animations, hide arrows, enable media and button helpers.
			*/
			$('.fancybox-media')
...
<body>
    <div id="wrapper">
        <nav class="navbar navbar-inverse navbar-fixed-top" role="navigation">
         ...
         <center><h3> <span class="glyphicon glyphicon-shopping-cart"></span> 寵物列表</h3></center>
        </div>
...
mysqli_select_db($conn,"petadopt");
...
$query=mysqli_query($conn,"select * from pets LIMIT $start, $limit");


while($query2=mysqli_fetch_array($query))
{
	
	echo "<div class='col-sm-3'><div class='panel panel-default' style='badopt-color:#008CBA;'>
            <div class='panel-heading' style='color:white;background-color : #033c73;'>
            <center> 
<textarea style='text-align:center;background-color: white;' class='form-control' rows='1' disabled>".$query2['pet_name']."</textarea>
			</center>
            </div>
            <div class='panel-body'>
           <a class='fancybox-buttons' href='../Admin/pet_images/".$query2['pet_image']."' data-fancybox-group='button' title='Page ".$id."- ".$query2['pet_name']."'>
					
					<img src='../Admin/pet_images/".$query2['pet_image']."' class='img img-thumbnail'  style='width:350px;height:150px;' />
					</a>
				
					
					<center><h4> 金額: $ ".$query2['pet_price']." </h4></center>
		
					
										<a class='btn btn-block btn-danger' href='add_to_cart.php?cart=".$query2['pet_id']."'><span class='glyphicon glyphicon-shopping-cart'></span> 新增到認養清單</a>
            </div>
          </div>
        </div>";
...
$rows=mysqli_num_rows(mysqli_query($conn,"select * from pets"));
